...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FilerImage.use_lightbox'
        db.add_column('cmsplugin_filerimage', 'use_lightbox',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FilerImage.link_data_lightbox'
        db.add_column('cmsplugin_filerimage', 'link_data_lightbox',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FilerImage.use_lightbox'
        db.delete_column('cmsplugin_filerimage', 'use_lightbox')

        # Deleting field 'FilerImage.link_data_lightbox'
        db.delete_column('cmsplugin_filerimage', 'link_data_lightbox')
    ...
    models = {
        ...
        'cmsplugin_filer_image.filerimage': {
            ...
            'link_data_lightbox': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
